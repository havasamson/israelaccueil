...
<body>
    ...
    <!-- Header Start -->
    <header id="menu" class="header white-bg header-sticky header-transparent">
        <nav class="navbar">
...
">
               ...
               <img src="logopng.png" style="max-width:85px" alt="Banner Image Placeholder" id="tilt">
    ...
    <!-- menubar area -->
    <section class="slider-area" data-scroll-index="0" style="
             ...
             <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    ...
                    <div class="slider-text">
                        ...
                        <h2>Accueil des expatriés francophones</h2>
    ...
    <section class="row about-us-area" id="about" data-scroll-index="1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 about-img wow slideInRight animated" data-wow-delay="0.3s">
                    <img src="image/imag1.jpg" alt="">
 <div class="row text-center index-2-title">
                        <a href="#contact" class="project-btn">Devenir membre</a>
                </div>
            </div>
      ...
      <section class="featured-work-area0" id="work" data-scroll-index="3">
        <div class="container">
            <div class="row text-center index-2-title">
            ...
            <div class="row text-center index-2-title">
            <a href="#contact" class="project-btn">En savoir plus</a>
        </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-5 plr0 bgcontact">
                    <div class="short-contact" style="text-align:center">
                        <div class="nav-logo">
                       <img src="logopng.png" style="max-width:175px" alt="Banner Image Placeholder">
                    </div>
                        <div class="short-contact-box2">
                            <h4>Adresse</h4>
                            <p>1/3 Ben Yehuda, Tel Aviv</p>
                        </div>
                        <div class="short-contact-box2">
                            <h4>Téléphone</h4>
                            <p>0587883055</p>
                ...
                <div class="col-sm-7">
                    <form class="form-area-right">
                        <div class="margintop">
                        <h3>Vous venez d'arriver en Israël ?</h3>
                            <h4>Devenez un membre de <b style="color:#1398D5;">Israël Accueil</b>,  <br>
                            Votre communauté francophone en Israël.</h4>
                            <br>
                        <p>Reçevez notre newsletter et profitez de réductions et d'offres spéciales.<br>
                        Pour plus d'informations, contactez-nous par e-mail, par téléphone <br>
                ...
                <div class="row footer_sidebar">
                    <div class="widget widget1 about_us_widget col-xs-6 col-sm-6 col-md-3">
                        <a href="http://fiafe.org" class="logo">
                              <img src="logopng.png" style="max-width:70px" alt="Banner Image Placeholder">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="fleft contact_mail">
                                        <a href="#">israelaccueil@gmail.com</a>
                                    </div>
                                </li>
                                <li>
